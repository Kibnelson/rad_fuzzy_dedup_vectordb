...
def tuples_to_items_vecs(
    ...
    for doc_id, mh in tuples_list:
        bitmap = minhash_to_bitmap_mmh3(mh, M=M_bits, seed=seed)
        vec = bitmap.view(uint8).reshape(1, -1)
...
def run_minhash_helper_batch_df(
    *,
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        # Normalize col names to what helper expects
...
def build_or_append_index(
    *,
    ...
    try:
        ...
        print(f" Could not write timeseries CSV: {e}")
