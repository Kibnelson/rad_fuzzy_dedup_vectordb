...
def process_wet_files(dataset_name, required_language, max_workers=None):
    ...
    # Step 2: Download and unzip WET files
    print("Downloading and unzipping WET files...")
    with open(paths_file, 'r') as f:
        file_paths = [line.strip() for line in f if line.strip()]

    # base_url = f"https://data.commoncrawl.org/crawl-data/{dataset_name}"
    ...
    # Step 3: Process WET files and save as Parquet
...
if __name__ == '__main__':
    ...
    process_wet_files(dataset_name, required_language)
